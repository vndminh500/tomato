...
const ComplaintsRefund = () => {
    return (
        <div className="privacy-policy">
            ...
            <p>
                At EatUp, we want every order to arrive as expected. This policy explains how to raise a complaint,
            ...
            <p>
                ...
                <Link to="/contact-us">Contact us</Link>, by email at eatup@gmail.com, or from your order details in
            ...
            <p>
                ...
                confirmed EatUp order. We may ask for additional information or check records with our kitchen and
                delivery partners before deciding.
            </p>

            <h2>Refunds and alternatives</h2>
            <p>
                Where we confirm that EatUp did not meet our service standards, we may offer a <strong>full or partial
            ...
            <p>
                ...
                escalation. A senior member of the EatUp support team will review your case.
            </p>
        </div>
    );
};
