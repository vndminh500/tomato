...
const Delivery = () => {
    return (
        <div className="delivery-policy">
            ...
            <p>At EatUp, we are committed to providing you with a fast and reliable delivery service. Please read our delivery policy to understand how we process and deliver your orders.</p>
